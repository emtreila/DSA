...
class FixedCapBiMap {
	...
	// removes a key with all the values that belong to it. Returns a ValuePair with the values that were removed
	//    - if k had 2 associated values, these are in the ValuePair
	//    - if k had only 1 associated value, the first component of the ValuePair is the value and the second component is NULL_TVALUE
	//    - if k was not in the map, both components of the ValuePair are NULL_TVALUE
